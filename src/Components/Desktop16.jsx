...
export const Desktop16 = () => {
      ...
      <div className="sectionbg-purple-25">
        <div className="divcontainer">
          ...
          <div className="figureh-full2" style={{width:"460px"}}>
                ...
                <img className="avatar-icon2" alt="img" src={require('../assets/Avatar3.png')} />
              </div>
              </div>
          </Item>
        </Carousel>
  ...
  */}
          ...
          <div className="content">
            <b className="create-exponential-value">
              Create exponential value with hybrid cloud
            </b>
            <div className="devsecops">DevSecOps</div>
            <div className="lorem-ipsum-dolor">{`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Porttitor justo, enim eu aliquam. Eget et pharetra pharetra, amet tortor sagittis senectus. Dictum ultrices `}</div>
          </div>
      ...
      <div className="solutions" ref={ref}>
        ...
        <div className="text-parent">
          <div className="text" />
          <div className="text1" />
          <div className="predefined-instance-type">
            {" "}
...
<path d="M6.39377 12.184C5.34843 12.184 4.38843 11.9387 3.51377 11.448C2.6391 10.936 1.9351 10.2533 1.40177 9.4C0.868432 8.54667 0.601766 7.58667 0.601766 6.52C0.601766 5.53867 0.847099 4.62133 1.33777 3.768C1.84977 2.89333 2.5431 2.18933 3.41777 1.656C4.29243 1.10133 5.28443 0.823999 6.39377 0.823999C7.41777 0.823999 8.3671 1.06933 9.24177 1.56C10.1378 2.05067 10.8524 2.73333 11.3858 3.608C11.9191 4.46133 12.1858 5.432 12.1858 6.52C12.1858 7.56533 11.9191 8.51467 11.3858 9.368C10.8738 10.2213 10.1804 10.904 9.30577 11.416C8.4311 11.928 7.46043 12.184 6.39377 12.184Z" fill="#62B62C"/>
</svg> &nbsp; Predefined Instance type configurations from small general purpose
            workloads to large memory instensive workloads
          </div>
      ...
      <Row>
        <Col style={{
         color:"#0032A1", fontSize:"24px", fontFamily:"inter", fontWeight:"bold"
        }}>
...
<stop offset="1" stop-color="#01E2A2"/>
   ...
   <div style={{fontSize:"15px", fontFamily:"inter",fontWeight:"bold", color:"#62B62C"}}>Arbour
    ...
    Max.IOPS
          ...
          <div className="each-instance-type" >
          <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M6.39377 12.184C5.34843 12.184 4.38843 11.9387 3.51377 11.448C2.6391 10.936 1.9351 10.2533 1.40177 9.4C0.868432 8.54667 0.601766 7.58667 0.601766 6.52C0.601766 5.53867 0.847099 4.62133 1.33777 3.768C1.84977 2.89333 2.5431 2.18933 3.41777 1.656C4.29243 1.10133 5.28443 0.823999 6.39377 0.823999C7.41777 0.823999 8.3671 1.06933 9.24177 1.56C10.1378 2.05067 10.8524 2.73333 11.3858 3.608C11.9191 4.46133 12.1858 5.432 12.1858 6.52C12.1858 7.56533 11.9191 8.51467 11.3858 9.368C10.8738 10.2213 10.1804 10.904 9.30577 11.416C8.4311 11.928 7.46043 12.184 6.39377 12.184Z" fill="#62B62C"/>
</svg> &nbsp; Each instance type has precise specifications, including the number
            of vCPUs, memory capacity, and network performance.
          </div>
          <b className="alpha-storage-services">Alpha Storage Services</b>
          <div className="a-5">
      <Link to='/learn'> <div className="learn-more">Learn More</div> </Link> 
...
<path d="M6.39377 12.184C5.34843 12.184 4.38843 11.9387 3.51377 11.448C2.6391 10.936 1.9351 10.2533 1.40177 9.4C0.868432 8.54667 0.601766 7.58667 0.601766 6.52C0.601766 5.53867 0.847099 4.62133 1.33777 3.768C1.84977 2.89333 2.5431 2.18933 3.41777 1.656C4.29243 1.10133 5.28443 0.823999 6.39377 0.823999C7.41777 0.823999 8.3671 1.06933 9.24177 1.56C10.1378 2.05067 10.8524 2.73333 11.3858 3.608C11.9191 4.46133 12.1858 5.432 12.1858 6.52C12.1858 7.56533 11.9191 8.51467 11.3858 9.368C10.8738 10.2213 10.1804 10.904 9.30577 11.416C8.4311 11.928 7.46043 12.184 6.39377 12.184Z" fill="#62B62C"/>
          ...
          <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M6.39377 12.184C5.34843 12.184 4.38843 11.9387 3.51377 11.448C2.6391 10.936 1.9351 10.2533 1.40177 9.4C0.868432 8.54667 0.601766 7.58667 0.601766 6.52C0.601766 5.53867 0.847099 4.62133 1.33777 3.768C1.84977 2.89333 2.5431 2.18933 3.41777 1.656C4.29243 1.10133 5.28443 0.823999 6.39377 0.823999C7.41777 0.823999 8.3671 1.06933 9.24177 1.56C10.1378 2.05067 10.8524 2.73333 11.3858 3.608C11.9191 4.46133 12.1858 5.432 12.1858 6.52C12.1858 7.56533 11.9191 8.51467 11.3858 9.368C10.8738 10.2213 10.1804 10.904 9.30577 11.416C8.4311 11.928 7.46043 12.184 6.39377 12.184Z" fill="#62B62C"/>
</svg> &nbsp;  Offer various storage services for the Alpha Compute Instances, like
            Block, Object Store and File services, in a massively scalable model
          </div>
   ...
   <div style={{fontSize:"15px", fontFamily:"inter",fontWeight:"bold", color:"#62B62C"}}>stb2
    ...
    Max.IOPS
        ...
        <div className="text-container">
          ...
          <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M6.39377 12.184C5.34843 12.184 4.38843 11.9387 3.51377 11.448C2.6391 10.936 1.9351 10.2533 1.40177 9.4C0.868432 8.54667 0.601766 7.58667 0.601766 6.52C0.601766 5.53867 0.847099 4.62133 1.33777 3.768C1.84977 2.89333 2.5431 2.18933 3.41777 1.656C4.29243 1.10133 5.28443 0.823999 6.39377 0.823999C7.41777 0.823999 8.3671 1.06933 9.24177 1.56C10.1378 2.05067 10.8524 2.73333 11.3858 3.608C11.9191 4.46133 12.1858 5.432 12.1858 6.52C12.1858 7.56533 11.9191 8.51467 11.3858 9.368C10.8738 10.2213 10.1804 10.904 9.30577 11.416C8.4311 11.928 7.46043 12.184 6.39377 12.184Z" fill="#62B62C"/>
</svg> &nbsp;  Makes complex network administrations very simple on self service
            fashion with just a few mouse clicks.
          </div>
...
<span id="counter5" /> &nbsp; %
   ...
   Operating
          ...
          <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M6.39377 12.184C5.34843 12.184 4.38843 11.9387 3.51377 11.448C2.6391 10.936 1.9351 10.2533 1.40177 9.4C0.868432 8.54667 0.601766 7.58667 0.601766 6.52C0.601766 5.53867 0.847099 4.62133 1.33777 3.768C1.84977 2.89333 2.5431 2.18933 3.41777 1.656C4.29243 1.10133 5.28443 0.823999 6.39377 0.823999C7.41777 0.823999 8.3671 1.06933 9.24177 1.56C10.1378 2.05067 10.8524 2.73333 11.3858 3.608C11.9191 4.46133 12.1858 5.432 12.1858 6.52C12.1858 7.56533 11.9191 8.51467 11.3858 9.368C10.8738 10.2213 10.1804 10.904 9.30577 11.416C8.4311 11.928 7.46043 12.184 6.39377 12.184Z" fill="#62B62C"/>
</svg> &nbsp;  Allows multitude of automations, it continues to have the zero trust
            security.
          </div>
...
<Card>
    <title>Test</title>
    <p>Predefined Instance type configurations from small general purpose workloads to large memory instensive workloads
  68,000
stb1
</p>
</Card>
        ...
        <div className="features1" >
          ...
          <div className="rectangle-group">
            ...
            <div className="complete-research-parent">
              <div className="complete-research">Complete Research</div>
              <img
     ...
     <div className="timeline">
        ...
        <div className="year-2023">
          ...
          <div className="content1">
            <img className="content-child" alt="" src="/line-2.svg" />
        ...
        <div className="year-2021">
          ...
          <div className="content1">
            <img className="content-child" alt="" src="/line-21.svg" />
            <div className="unleash-business-resilience">
              Unleash business resilience with enterprise cloud.
            </div>
          </div>
        ...
        <div className="year-2022">
          <div className="content3">
            ...
            <img className="content-child" alt="" src="/line-22.svg" />
          </div>
        ...
        <div className="year-2020">
          <div className="content3">
            ...
            <img className="content-child" alt="" src="/line-23.svg" />
          </div>
        ...
        <div className="year-2019">
          ...
          <div className="content1">
            <img className="content-child" alt="" src="/line-24.svg" />
            <div className="unleash-business-resilience">
              Unleash business resilience with enterprise cloud.
            </div>
          </div>
      ...
      <div className="hero-1">
        ...
        <div className="home" onClick={handleClick1} style={{cursor:'pointer', color:"#121517"}}>Home</div>
        ...
        <div className="products"  onClick={handleClick2} style={{textDecoration:"none", color:"#121517"}}>Products</div>
        <div className="learn"><Link to="/learn" style={{textDecoration:"none", color:"#121517"}}>Learn</Link></div>
      </div>
